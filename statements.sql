...
-- Tu respuesta aquí
SELECT COUNT(DISTINCT lenguaje) FROM usuarios_lenguajes;

-- Ejercicio 22: Encontrar el lenguaje con más caracteres.
-- Tu respuesta aquí
SELECT lenguaje
FROM usuarios_lenguajes
ORDER BY CHAR_LENGTH(lenguaje) DESC
LIMIT 1;
...
-- Tu respuesta aquí
SELECT edad, GROUP_CONCAT(nombre SEPARATOR ', ') AS usuarios_con_misma_edad 
FROM usuarios_lenguajes GROUP BY edad HAVING COUNT(*) > 1;

-- Ejercicio 26: Encontrar el usuario con el lenguaje con mayor número de carácteres y que tenga una edad menor de 30 años. 
-- Tu respuesta aquí
SELECT nombre,apellido
FROM usuarios_lenguajes WHERE edad < 30
ORDER BY CHAR_LENGTH(lenguaje) DESC
LIMIT 1;
...
-- Tu respuesta aquí
SELECT lenguaje
FROM usuarios_lenguajes WHERE lenguaje LIKE 'J%' 
ORDER BY CHAR_LENGTH(lenguaje) ASC
LIMIT 1;
...
-- Tu respuesta aquí
SELECT nombre, CHAR_LENGTH(nombre) AS longitud_nombre FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL ORDER BY longitud_nombre;
